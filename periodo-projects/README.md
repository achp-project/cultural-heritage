...
The [list of wikidata links for each period region](../wikidata_period.tsv) and a [polygon file for mapping the wkt regions](../period_regions.tsv) are in tsv format.
